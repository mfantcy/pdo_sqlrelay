--TEST--
PDO SQLRELAY MySQL PDOStatement->fetch(), PDO::FETCH_SERIALIZE
--SKIPIF--
...
try {
	...
	$db->exec(sprintf('CREATE TABLE test(id INT, myobj BLOB) ENGINE=%s', PDOSqlrelayMysqlTestConfig::getStorageEngin()));
